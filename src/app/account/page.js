...
export default function Track() {
  const [trackingId, setTrackingId] = useState(""); // Input handle karne ke liye
  const [statusResult, setStatusResult] = useState(null); // Database se aya hua data
...
<main className="min-h-screen w-full bg-white">
      ...
      <div className="w-full flex justify-center px-4 md:px-12 mt-1 md:mt-2">
        ...
        <div className="relative overflow-hidden rounded-[8px] md:rounded-[10px] mx-auto" style={{ height: isMobile ? "300px" : "600px", width: isMobile ? "95%" : "100%", maxWidth: "1280px" }}>
          ...
          <img src="/images/accountbg.webp" alt="Main Banner" className="w-full h-full object-cover block shadow-sm" />
  ...
  <div className="w-full max-w-[800px] flex flex-col items-center">
    ...
    <div className="text-center mb-16">
      <h2 
        ...
        className="text-[#67645e] text-3xl md:text-5xl font-light leading-tight"
      >
        Where is your <span className="italic text-[#8f645e]">Charmeluna</span> glow?
      </h2>
    ...
    >
      ...
      <button 
        ...
        style={{ 
          ...
          borderRadius: '100px',
          border: '1px solid #8f645e30',
          fontFamily: 'Swiss, sans-serif'
        }}
      >
        <span className="relative z-10 flex flex-col items-center">
          <span className="text-[10px] uppercase font-medium tracking-[0.5em] text-[#67645e] group-hover:text-[#8f645e] transition-all">
...
<div className="w-full flex flex-col items-center min-h-[150px]"> 
  ...
  {statusResult && (
    ...
    >
      ...
      <h3 
        style={{ fontFamily: 'Gowun Batang, serif', letterSpacing: '0.05em' }} 
        className="text-3xl md:text-4xl text-[#8f645e] italic mb-10"
      >
        {statusResult.status}
      </h3>
